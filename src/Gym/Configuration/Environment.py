...
ABB_IRB_14000_R_Env_ID_0_Str.C.Search = Cuboid_Str(HTM_Cls(None, np.float64).Translation(np.array([0.40, -0.20, 0.135], dtype=np.float64)), 
                                                   np.array([0.175, 0.25, 0.225], dtype=np.float64), [0.975, 1.0, 0.60])
ABB_IRB_14000_R_Env_ID_0_Str.C.Target = Cuboid_Str(HTM_Cls(None, np.float64).Translation(np.array([0.40, -0.20, 0.065], dtype=np.float64)), 
...
ABB_IRB_14000_R_Env_ID_1_Str.C.Search = Cuboid_Str(HTM_Cls(None, np.float64).Translation(np.array([0.40, -0.20, 0.135], dtype=np.float64)), 
                                                   np.array([0.175, 0.25, 0.225], dtype=np.float64), [0.975, 1.0, 0.60])
...
ABB_IRB_14000_L_Env_ID_0_Str.C.Search = Cuboid_Str(HTM_Cls(None, np.float64).Translation(np.array([0.40, 0.20, 0.135], dtype=np.float64)), 
                                                   np.array([0.175, 0.25, 0.225], dtype=np.float64), [0.975, 1.0, 0.60])
ABB_IRB_14000_L_Env_ID_0_Str.C.Target = Cuboid_Str(HTM_Cls(None, np.float64).Translation(np.array([0.40, 0.20, 0.065], dtype=np.float64)), 
                                                   np.array([0.100, 0.200, 0.050], dtype=np.float64), [0.60, 1.0, 0.60])
ABB_IRB_14000_L_Env_ID_0_Str.Collision_Object = None
#   Environmnet ID 1.
ABB_IRB_14000_L_Env_ID_1_Str = Environment_Str(Name='ABB_IRB_14000_L')
ABB_IRB_14000_L_Env_ID_1_Str.C.Search = Cuboid_Str(HTM_Cls(None, np.float64).Translation(np.array([0.40, 0.20, 0.135], dtype=np.float64)), 
                                                   np.array([0.175, 0.25, 0.225], dtype=np.float64), [0.975, 1.0, 0.60])
ABB_IRB_14000_L_Env_ID_1_Str.C.Target = Cuboid_Str(HTM_Cls(None, np.float64).Translation(np.array([0.40, 0.115, 0.065], dtype=np.float64)), 
                                                   np.array([0.100, 0.075, 0.050], dtype=np.float64), [0.60, 1.0, 0.60])
ABB_IRB_14000_L_Env_ID_1_Str.Collision_Object.T = HTM_Cls(None, np.float64).Translation([0.40, 0.245, 0.175])
