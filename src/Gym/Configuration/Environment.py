...
ABB_IRB_14000_R_Env_ID_0_Str.C.Search = Cuboid_Str(HTM_Cls(None, np.float64).Translation(np.array([0.35, -0.15, 0.145], dtype=np.float64)), 
                                                   np.array([0.175, 0.30, 0.25], dtype=np.float64), [0.975, 1.0, 0.60])
...
ABB_IRB_14000_R_Env_ID_1_Str.C.Search = Cuboid_Str(HTM_Cls(None, np.float64).Translation(np.array([0.40, -0.15, 0.145], dtype=np.float64)), 
                                                   np.array([0.175, 0.30, 0.25], dtype=np.float64), [0.975, 1.0, 0.60])
ABB_IRB_14000_R_Env_ID_1_Str.C.Target = Cuboid_Str(HTM_Cls(None, np.float64).Translation(np.array([0.40, -0.065, 0.065], dtype=np.float64)), 
                                                   np.array([0.125, 0.075, 0.05], dtype=np.float64), [0.60, 1.0, 0.60])
ABB_IRB_14000_R_Env_ID_1_Str.Collision_Object.T = HTM_Cls(None, np.float64).Translation([0.40, -0.205, 0.195])
...
ABB_IRB_14000_L_Env_ID_0_Str.C.Search = Cuboid_Str(HTM_Cls(None, np.float64).Translation(np.array([0.40, 0.15, 0.145], dtype=np.float64)), 
                                                   np.array([0.175, 0.30, 0.25], dtype=np.float64), [0.975, 1.0, 0.60])
ABB_IRB_14000_L_Env_ID_0_Str.C.Target = Cuboid_Str(HTM_Cls(None, np.float64).Translation(np.array([0.40, 0.15, 0.095], dtype=np.float64)), 
                                                   np.array([0.125, 0.225, 0.10], dtype=np.float64), [0.60, 1.0, 0.60])
ABB_IRB_14000_L_Env_ID_0_Str.Collision_Object = None
#   Environmnet ID 1.
ABB_IRB_14000_L_Env_ID_1_Str = Environment_Str(Name='ABB_IRB_14000_L')
ABB_IRB_14000_L_Env_ID_1_Str.C.Search = Cuboid_Str(HTM_Cls(None, np.float64).Translation(np.array([0.40, 0.15, 0.145], dtype=np.float64)), 
                                                   np.array([0.175, 0.30, 0.25], dtype=np.float64), [0.975, 1.0, 0.60])
ABB_IRB_14000_L_Env_ID_1_Str.C.Target = Cuboid_Str(HTM_Cls(None, np.float64).Translation(np.array([0.40, 0.065, 0.065], dtype=np.float64)), 
                                                   np.array([0.125, 0.075, 0.05], dtype=np.float64), [0.60, 1.0, 0.60])
ABB_IRB_14000_L_Env_ID_1_Str.Collision_Object.T = HTM_Cls(None, np.float64).Translation([0.40, 0.205, 0.195])
ABB_IRB_14000_L_Env_ID_1_Str.Collision_Object.Scale = 0.015
