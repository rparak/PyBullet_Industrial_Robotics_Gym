...
Universal_Robots_UR3_C_Str.Search = Cuboid_Str(HTM_Cls(None, np.float64).Translation(np.array([0.30, 0.0, 0.150 + 0.02], dtype=np.float64)), 
...
ABB_IRB_120_C_Str.Target = Cuboid_Str(HTM_Cls(None, np.float64).Translation(np.array([0.35, 0.0, 0.120 + 0.02], dtype=np.float64)), 
...
ABB_IRB_120_L_Ax_C_Str.Search = Cuboid_Str(HTM_Cls(None, np.float64).Translation(np.array([0.35, 0.4, 0.225 + 0.113 + 0.02], dtype=np.float64)), 
                                           np.array([0.20, 0.30, 0.40], dtype=np.float64), [1.0, 1.0, 0.0])
ABB_IRB_120_L_Ax_C_Str.Target = Cuboid_Str(HTM_Cls(None, np.float64).Translation(np.array([0.35, 0.4, 0.120 + 0.113 + 0.02], dtype=np.float64)), 
                                           np.array([0.15, 0.25, 0.15], dtype=np.float64), [0.0, 1.0, 0.0])
