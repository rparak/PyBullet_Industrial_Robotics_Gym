...
def main():
    ...
    if 'HER' in CONST_ALGORITHM:
        model = stable_baselines3.DDPG.load(f'{CONST_PROJECT_FOLDER}/Data/Model/Environment_{CONST_ENV_MODE}/{CONST_ALGORITHM}/{Robot_Str.Name}/model', env=gym_environment)
    else:
